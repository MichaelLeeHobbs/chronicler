...
All checks in this agent are **judgment-based** and cannot be automated by ESLint or TypeScript. No checks are delegated to static tooling. Your full review scope applies.
